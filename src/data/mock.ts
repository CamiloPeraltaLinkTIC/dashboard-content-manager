...
export const legitimidadData = {
  ...
  indiceProcesos: 68,
  encuestas: [
    { mes: "Dic", confianza: 68, transparencia: 72 },
    { mes: "Ene", confianza: 70, transparencia: 74 },
    { mes: "Feb", confianza: 71, transparencia: 75 },
    { mes: "Mar", confianza: 72, transparencia: 78 },
    { mes: "Abr", confianza: 73, transparencia: 80 },
    { mes: "May", confianza: 74, transparencia: 81 },
    { mes: "Jun", confianza: 75, transparencia: 82 },
  ],
  certificaciones: [
